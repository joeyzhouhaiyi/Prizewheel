...
export interface PrizeWheelRef1 {
  spin: () => void;
  isSpinning: boolean;
  reset: () => void;
}

const PrizeWheelSilver = forwardRef<PrizeWheelRef1, WheelProps>(({}, ref) => {
  ...
  useEffect(() => {
    if (canvasRef.current) {
      ...
      img.src = '/wheel-silver.png'; // Ensure this path is correct
    }
  }, []);
  ...
  return (
    <div style={{ position: 'relative', width: 512, height: 512 }}>
      ...
      <canvas id="canvas-silver" ref={canvasRef} width={512} height={512} />
...
export default PrizeWheelSilver;
